...
EINTERN Eina_Bool    e_mod_qpmgr_quickpanel_handler_geometry_set(int x, int y, int width, int height);
...
EINTERN void         e_mod_qpmgr_quickpanel_server_init(void);
EINTERN void         e_mod_qpmgr_quickpanel_server_shutdown(void);
